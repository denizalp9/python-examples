...
import os
import locale
import win32api # .exeye çevirmede sıkıntı çıkartıyor.
...
LONGSLEEP = ["kafana göre takıl", "takıl kafana göre", "teşekkür ederim", "sağol canım", "afk", "uyu"]
QUIT = ["Çık", "çık", "çıkış", "kapat", "programı sonlandır", "sonlandır", "quit", "exit", "kendine iyi bak", "hadi eyvallah"]
